...
function LiquidityRemover(props) {
  ...
  const [router, setRouter] = React.useState(
    getRouter("0xA5E720FcBCfd4c20D77a199Fb5B19Ced9b811A04", signer)
  );
  const [weth, setWeth] = React.useState(
    getWeth("0x31A75e41f9969e04C0Ec28cE73E6Bdda01829819", signer)
  );
  const [factory, setFactory] = React.useState(
    getFactory("0x2f8133c2fc2839433D83A330503b277C614Cf084", signer)
  );
